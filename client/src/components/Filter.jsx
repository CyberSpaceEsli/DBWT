...
<div className="my-5 lg:container md:mx-auto p-6 lg:p-0">
    ...
    <ul className="items-center w-full text-sm font-medium text-gray-900 bg-white border border-indigo-200 rounded-lg lg:flex">
        <li className="w-full border-b border-indigo-200 lg:border-b-0 lg:border-r">
            <div className="flex items-center ps-3">
                <input id="checkbox-all-institutions" type="checkbox" value="" onChange={handleCheckboxChange(setShowAll)} className="w-4 h-4 bg-gray-100 border-gray-300 rounded focus:ring-indigo-400 focus:ring-1" />
        ...
        <div className="flex">       
                <div className="w-full flex items-center ps-3">
                    <input id="checkbox-schools" type="checkbox" value="" onChange={handleCheckboxChange(setShowSchoolDetails)} className="w-4 h-4 bg-gray-100 border-gray-300 rounded focus:ring-indigo-400 focus:ring-1 accent-red-400"/>
        ...
        <li className="w-full border-b border-indigo-200 lg:border-b-0 lg:border-r">
            <div className="flex items-center ps-3">
                <input id="checkbox-kindergarden" type="checkbox" value="" onChange={handleCheckboxChange(setShowKindergardenDetails)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-400 focus:ring-1  accent-blue-400" />
            ...
            <li className="w-full border-b border-indigo-200 lg:border-b-0 lg:border-r">
            <div className="flex items-center ps-3">
                <input id="checkbox-social-work" type="checkbox" value="" onChange={handleCheckboxChange(setShowSocialChildProjectDetails)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-400 focus:ring-1  accent-pink-400" />
        ...
        <li className="w-full">
            <div className="flex items-center ps-3">
                <input id="checkbox-youth-work-assistance" type="checkbox" value="" onChange={handleCheckboxChange(setShowSocialTeenagerProjectDetails)} className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-indigo-400 focus:ring-1  accent-purple-400"/>
    ...
    <div className="mt-5">
        <button type="submit" className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-60">Favorite Einrichtung entfernen</button>
    </div>
