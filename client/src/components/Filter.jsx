    ...
    <ul className="items-center w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg lg:flex">
        ...
        <div className="flex">       
                <div className="w-full flex items-center ps-3">
                    ...
                    <label htmlFor="checkbox-schools" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 grid grid-cols-2 items-center lg:grid-cols-4 2xl:grid-cols-6">Schulen <div className="ml-1 h-2 w-2 rounded-full bg-red-400 justify-self-end lg:justify-self-start mr-3 lg:mr-0"></div></label>
                </div>
            </div>
        </li>
        <li className="w-full border-b border-gray-200 lg:border-b-0 lg:border-r">
            <div className="flex items-center ps-3">
                ...
                <label htmlFor="checkbox-kindergarden" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 grid grid-cols-2 items-center lg:gap-12 2xl:gap-8 2xl:grid-cols-3">Kindertagesstätten <div className="2xl:ml-2 h-2 w-2 rounded-full bg-blue-400 justify-self-end lg:justify-self-start mr-3 lg:mr-0"></div></label>
            </div>
        </li>
            <li className="w-full border-b border-gray-200 lg:border-b-0 lg:border-r">
            <div className="flex items-center ps-3">
                ...
                <label htmlFor="checkbox-social-work" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 grid grid-cols-2 items-center lg:gap-4 2xl:gap-0 2xl:grid-cols-3">Schulsozialarbeit <div className="2xl:ml-2 h-2 w-2 rounded-full bg-pink-400 justify-self-end lg:justify-self-start mr-3 lg:mr-0"></div></label>
            </div>
        </li>
        <li className="w-full">
            <div className="flex items-center ps-3">
                ...
                <label htmlFor="checkbox-youth-work-assistance" className="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 grid grid-cols-2 items-center lg:gap-12 2xl:gap-8 2xl:grid-cols-3">Jugendberufshilfen <div className="2xl:ml-2 h-2 w-2 rounded-full bg-purple-400 justify-self-end lg:justify-self-start mr-3 lg:mr-0"></div></label>
            </div>
        </li>
    </ul>
