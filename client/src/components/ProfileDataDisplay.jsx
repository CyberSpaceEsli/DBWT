...
export default function ProfileDataDisplay({ username }) {
  ...
  return (
    <div className="mt-10 border-t border-slate-300">
       <div href="#" className="mt-8 block p-6 bg-white border border-gray-200 rounded-lg shadow-md shadow-indigo-100">
          ...
          <p className="font-semibold text-gray-700">Die Lieblingseinrichtung:</p> 
         <div className="mt-2 flex">
          <p id="facility" className="block text-sm leading-6 text-gray-900">Grundschule Blah</p>
        ...
        <p className="font-semibold text-gray-700 min-w-full">Die Heimadresse: </p>

        <div className="">
          <p id="street" className="mt-2 block text-sm leading-6 text-gray-900">Senefelderstr 1</p>
