...
export default function ProfileDataDisplay({ profileId, street, city, plz, username, isAuthenticated }) {
       ...
       <div href="#" className="mt-8 block p-6 bg-white border border-gray-200 rounded-lg shadow-md shadow-indigo-100">
        ...
        <p className="font-semibold min-w-full">Heimadresse: </p>
          ...
          <div>
            ...
            <p id="street" className="block text-sm leading-6 text-gray-900 pr-4">{street}</p>
            ...
            <p id="city" className="block text-sm leading-6 text-gray-900">{city}</p>
            <p id="plz" className="block text-sm leading-6 text-gray-900">{plz}</p>
          </div> 
