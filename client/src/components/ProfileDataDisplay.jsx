...
export default function ProfileDataDisplay({ profileId, profile, username, isAuthenticated }) { 
  ...
  return (
    <div className="mt-10">
       <div href="#" className="mt-8 block p-6 bg-white border border-gray-200 rounded-lg">
          <h5 className="mb-2 text-2xl font-bold tracking-tight">Ihre gespeicherten Daten zum Profil: <span className="text-red-400">{username}</span>.</h5><br />
          
          <div className="mt-2 grid gap-16 grid-cols-2 items-center">
          <p className="font-semibold ">Lieblingseinrichtung:</p> 
          <div className="flex justify-end">
                  <button onClick={handleDeleteFavFacility} className="flex items-center cursor-pointer w-6 h-6 rounded-full bg-green-400 hover:bg-green-500 justify-center" title="Löschen">
        ...
        <div className="mt-4 mb-4 border-t border-slate-300"></div>
         ...
         <div className="mt-2 grid gap-16 grid-cols-2 items-center">
            ...
            <div className="flex justify-end">
                  <button className="flex items-center cursor-pointer w-6 h-6 rounded-full bg-green-400 hover:bg-green-500 justify-center" onClick={handleDeleteAddress} title="Alles löschen">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className=" text-white h-3.5 w-3.5 hover:pointer-cursor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                    </svg>
                </button>
